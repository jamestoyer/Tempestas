Public Class frmBothTimetable
    ...
    ''' <summary>
    ''' Stores the controls for setting up a both timetable system
    ''' </summary>
    ''' <remarks></remarks>
    Public twsWeek(0, 0) As TermAndWeekSetup
...
#Region "Form Inherited Events"
    ...
    Public Overridable Sub CreateNewYears(ByVal intStartYear As Integer, ByVal intEndYear As Integer, ByVal intStartTerm As Integer, ByVal intEndTerm As Integer)
        ...
        For intCurrentYearEntry = intStartYear To intEndYear
            ...
            pnlYearPanel(intCurrentYearEntry).Size = New System.Drawing.Size(477, 146)
    ...
    Public Overridable Sub CreateNewTerms(ByVal intCurrentYearEntry As Integer, ByVal intStartTerm As Integer, ByVal intEndTerm As Integer)
        ...
        For intCurrentTermEntry = intStartTerm To intEndTerm
            ...
            twsWeek(intCurrentYearEntry, intCurrentTermEntry) = New TermAndWeekSetup

            ' Create the both set up control
            twsWeek(intCurrentYearEntry, intCurrentTermEntry).BackColor = System.Drawing.Color.White
            twsWeek(intCurrentYearEntry, intCurrentTermEntry).TermNumber = intCurrentTermEntry
            twsWeek(intCurrentYearEntry, intCurrentTermEntry).Dock = System.Windows.Forms.DockStyle.Top
            twsWeek(intCurrentYearEntry, intCurrentTermEntry).Location = New System.Drawing.Point(0, 0)
            twsWeek(intCurrentYearEntry, intCurrentTermEntry).Name = "twsTerm" & intCurrentTermEntry
            twsWeek(intCurrentYearEntry, intCurrentTermEntry).TermSetup = False

            ' Add the term set up to the panel
            pnlYearPanel(intCurrentYearEntry).Controls.Add(twsWeek(intCurrentYearEntry, intCurrentTermEntry))

            ' Send the control to the bottom of the panel
            twsWeek(intCurrentYearEntry, intCurrentTermEntry).BringToFront()
        Next
    End Sub
...
#End Region
    ...
    Private Sub txtTimetableName_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtTimetableName.KeyDown, txtYearName.KeyDown
