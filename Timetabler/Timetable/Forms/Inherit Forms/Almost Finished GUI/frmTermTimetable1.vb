Public Class frmTermTimetable1
...
#Region "Form Inherited Events"
    ...
    Public Overridable Sub CreateNewYears(ByVal intStartYear As Integer, ByVal intEndYear As Integer, ByVal intStartTerm As Integer, ByVal intEndTerm As Integer)
        ...
        For intCurrentYearEntry = intStartYear To intEndYear
            ...
            pnlYearPanel(intCurrentYearEntry).Size = New System.Drawing.Size(476, 140)
    ...
    Public Overridable Sub CreateNewTerms(ByVal intCurrentYearEntry As Integer, ByVal intStartTerm As Integer, ByVal intEndTerm As Integer)
        ...
        For intCurrentTermEntry = intStartTerm To intEndTerm
            ...
            tsuTermTSU(intCurrentYearEntry, intCurrentTermEntry) = New TermSetUp

            ' Create the term set up control
            tsuTermTSU(intCurrentYearEntry, intCurrentTermEntry).BackColor = System.Drawing.Color.White
            tsuTermTSU(intCurrentYearEntry, intCurrentTermEntry).ControlTerm = intCurrentTermEntry
            tsuTermTSU(intCurrentYearEntry, intCurrentTermEntry).Dock = System.Windows.Forms.DockStyle.Top
            tsuTermTSU(intCurrentYearEntry, intCurrentTermEntry).Location = New System.Drawing.Point(0, 10)
            tsuTermTSU(intCurrentYearEntry, intCurrentTermEntry).Name = "tsuTerm" & intCurrentTermEntry
            tsuTermTSU(intCurrentYearEntry, intCurrentTermEntry).Size = New System.Drawing.Size(477, 49)

            ' Add the term set up to the panel
            pnlYearPanel(intCurrentYearEntry).Controls.Add(tsuTermTSU(intCurrentYearEntry, intCurrentTermEntry))

            ' Send the control to the bottom of the panel
            tsuTermTSU(intCurrentYearEntry, intCurrentTermEntry).BringToFront()
        Next
    End Sub
