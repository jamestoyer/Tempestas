Public Class frmBothTimetable1
    ...
    ' Array to store the both set up controls
    Public bsuTermBSU(0, 0) As BothSetUp
...
#Region "Form Inherited Events"
    ...
    Public Overridable Sub CreateNewYears(ByVal intStartYear As Integer, ByVal intEndYear As Integer, ByVal intStartTerm As Integer, ByVal intEndTerm As Integer)
        ...
        For intCurrentYearEntry = intStartYear To intEndYear
            ...
            pnlYearPanel(intCurrentYearEntry).Size = New System.Drawing.Size(477, 140)
    ...
    Public Overridable Sub CreateNewTerms(ByVal intCurrentYearEntry As Integer, ByVal intStartTerm As Integer, ByVal intEndTerm As Integer)
        ...
        For intCurrentTermEntry = intStartTerm To intEndTerm
            ...
            bsuTermBSU(intCurrentYearEntry, intCurrentTermEntry) = New BothSetUp

            ' Create the both set up control
            bsuTermBSU(intCurrentYearEntry, intCurrentTermEntry).BackColor = System.Drawing.Color.White
            bsuTermBSU(intCurrentYearEntry, intCurrentTermEntry).ControlTerm = intCurrentTermEntry
            bsuTermBSU(intCurrentYearEntry, intCurrentTermEntry).Dock = System.Windows.Forms.DockStyle.Top
            bsuTermBSU(intCurrentYearEntry, intCurrentTermEntry).Location = New System.Drawing.Point(0, 0)
            bsuTermBSU(intCurrentYearEntry, intCurrentTermEntry).Name = "bsuTerm" & intCurrentTermEntry
            bsuTermBSU(intCurrentYearEntry, intCurrentTermEntry).Size = New System.Drawing.Size(456, 75)

            ' Add the term set up to the panel
            pnlYearPanel(intCurrentYearEntry).Controls.Add(bsuTermBSU(intCurrentYearEntry, intCurrentTermEntry))

            ' Send the control to the bottom of the panel
            bsuTermBSU(intCurrentYearEntry, intCurrentTermEntry).BringToFront()
        Next
    End Sub
