Public Class frmSelectModule

    Private Sub frmSelectModule_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ' Update the error label
        UpdateErrorLabel("Please select a module")
    ...
    Public Sub PopulateItemsList()
        ...
        sqlStatement = New SqlClient.SqlCommand("SELECT * FROM Module WHERE UserID = " & strUserInfo(intUserInfo.ID) & " AND TimetableID = " & intTimetable(intEnumTimetable.TimetableID) & " ORDER BY Code", ctnTimetable)
        ...
        Do While sqlResults.Read
            ...
            intEntryID(intIndex) = sqlResults!ModuleID

            ' Add the data to the list box
            lstEvents.Items.Add(sqlResults!Code & " " & sqlResults!Name)
    ...
    Private Sub btnModify_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnModify.Click
        ...
        ModifyButtonClicked(frmUpdateModule)
