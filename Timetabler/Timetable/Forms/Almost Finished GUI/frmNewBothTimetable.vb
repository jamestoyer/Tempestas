Public Class frmNewBothTimetable
...
#Region "Page One"
    Public Sub btnToPage2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnToPage2.Click
        ...
        If bolBackPressed = False Then
            ...
            ReDim twsWeek(intYears, intTerms)
        ...
        ElseIf bolBackPressed = True Then
            ...
            If intYears > CInt(txtYears.Text) Then
                ...
                Array.Copy(twsWeek, twsCopy, twsWeek.Length)
                ...
                For intCurrentYearEntry = 1 To intYears
                    For intCurrentTermEntry = 1 To intTerms
                        twsWeek(intCurrentYearEntry, intCurrentTermEntry) = twsCopy(intCurrentYearEntry, intCurrentTermEntry)
                    Next
                Next
            ElseIf intYears < CInt(txtYears.Text) Then
                ...
                ' Resize the term set up control array
                ReDim twsWeek(CInt(txtYears.Text), intTerms)
            ...
            If intTerms > CInt(txtTerms.Text) Then
                ...
                For intCurrentYearEntry = 1 To intYears
                    For intCurrentTermEntry = CInt(txtTerms.Text) + 1 To intTerms
                        ' Delete the control
                        twsWeek(intCurrentYearEntry, intCurrentTermEntry).Dispose()
                    Next
                Next
                ...
                ' Resize the term set up control array
                ReDim Preserve twsWeek(intYears, intTerms)
            ElseIf intTerms < CInt(txtTerms.Text) Then
                ' Resize the term set up control array
                ReDim Preserve twsWeek(intYears, CInt(txtTerms.Text))
    ...
    Private Sub btnCreate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCreate.Click
        ...
        For intCurrentYear As Integer = 1 To CInt(txtYears.Text.Trim)
            ...
            For intCurrentTerm As Integer = 1 To CInt(txtTerms.Text.Trim)
                With twsWeek(intCurrentYear, intCurrentTerm)
                ...
                ' Create a new term
                AddSevenFields("Term", "Number", intCurrentTerm, "StartDate", strStartDate, "FinishDate", strFinishDate, "Weeks", twsWeek(intCurrentYear, intCurrentTerm).txtLength.Text.Trim, "YearID", intTimetable(intEnumTimetable.YearID), "WeekStart", twsWeek(intCurrentYear, intCurrentTerm).txtStartWeek.Text.Trim, "WeekEnd", twsWeek(intCurrentYear, intCurrentTerm).txtFinishWeek.Text.Trim)
            Next
        Next
